...
<head>
 ...
 -->
    ...
    tinymce.init({
        ...
        toolbar: ' | undo redo | bold italic underline strikethrough | fontselect fontsizeselect formatselect | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist | forecolor backcolor removeformat |insertdatetime table | pagebreak | charmap emoticons | fullscreen  preview print | image link anchor | ltr rtl',
        toolbar_sticky: true,
